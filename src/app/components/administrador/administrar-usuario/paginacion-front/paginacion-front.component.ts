...
@Component({
  selector: 'app-paginacion-front',
  templateUrl: './paginacion-front.component.html',
  styleUrls: ['./paginacion-front.component.css'],
})
export class PaginacionFrontComponent implements OnInit {
  ...
  dsUsuarios: MatTableDataSource<Usuario>;
